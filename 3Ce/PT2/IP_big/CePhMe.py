...
mol.atom = '''
       Ce    0.000000    0.000000    0.000000
        N1   -1.922661    0.723329   -1.565825
        N1    0.334909   -2.026738   -1.565825
        N1    1.587752    1.303409   -1.565825
        N2   -3.091228    0.118782   -1.179810
        N2    1.442746   -2.736473   -1.179810
        N2    1.648482    2.617691   -1.179810
        N2   -3.035207   -0.019312    1.331579
        N2    1.534329   -2.618910    1.331579
        N2    1.500878    2.638223    1.331579
        N1   -1.878574    0.650064    1.660681
        N1    0.376316   -1.951925    1.660681
        N1    1.502259    1.301861    1.660681
...
mol.basis = {'Ce': gto.basis.parse(bse.get_basis('ANO-RCC-VTZP',elements='Ce',fmt='nwchem')),'C' : gto.basis.parse(bse.get_basis('ANO-R0',elements='C', fmt='nwchem')),
                                               'N1' : gto.basis.parse(bse.get_basis('ANO-RCC-VTZP',elements='N', fmt='nwchem')),
                                               'N2' : gto.basis.parse(bse.get_basis('ANO-RCC-VTZP',elements='N', fmt='nwchem')),
...
imp_inds = mol.search_ao_label(['Ce.*','N1.*'])
thres = 1e-12
